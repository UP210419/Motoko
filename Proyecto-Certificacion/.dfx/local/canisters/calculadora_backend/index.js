...
import { idlFactory } from './calculadora_backend.did.js';
export { idlFactory } from './calculadora_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_CALCULADORA_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./calculadora_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the calculadora_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./calculadora_backend.did.js")._SERVICE>}
 */
export const calculadora_backend = createActor(canisterId);
